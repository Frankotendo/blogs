...
/**
 * Uses Gemini to extract and verify details from a Mobile Money receipt screenshot.
 * Updated to use gemini-3-flash-preview for multimodal extraction.
 */
...
/**
 * Uses Gemini to compare a live selfie against a reference identity photo.
 * Updated to use gemini-3-flash-preview for high-accuracy multimodal comparison.
 */
