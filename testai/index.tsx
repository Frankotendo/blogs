...
// Temporary fix: Disable LiveMap to prevent black screen
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        {LiveMap ? (
          ...
          <div className="glass p-8 rounded-[2rem] border border-white/10 text-center">
            <div className="w-16 h-16 bg-amber-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="fas fa-map-marked-alt text-amber-500 text-2xl"></i>
            </div>
            <p className="text-white font-black mb-2">Live Map Coming Soon</p>
            <p className="text-slate-400 text-sm">Real-time tracking is being set up</p>
          </div>
        )}
      </div>
      ...
      <div className="space-y-4">
        ...
        {LiveMap ? (
          <LiveMap
            ...
            vehicleLabel={activeDriver?.name ? `${activeDriver.name} - ${activeDriver.vehicleType}` : undefined}
          />
        ) : (
          <div className="glass p-8 rounded-[2rem] border border-white/10 text-center">
            <div className="w-16 h-16 bg-indigo-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="fas fa-location-arrow text-indigo-500 text-2xl"></i>
            </div>
            <p className="text-white font-black mb-2">Live Tracking Coming Soon</p>
            <p className="text-slate-400 text-sm">Real-time location sharing is being set up</p>
          </div>
        )}
      </div>
