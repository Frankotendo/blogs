...
import { safeLog, getEnvironment } from "./utils/environment";
...
const setupGlobalErrorHandlers = () => {
  ...
  window.addEventListener('error', (event) => {
    safeLog.error('Global JavaScript Error', {
    ...
    // Show alert in production/preview
  ...
  root.render(
    <ErrorBoundary
      onError={(error, errorInfo) => {
        // Safe error logging for all environments
        safeLog.error('Global App Error', { error, errorInfo });
