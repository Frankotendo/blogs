        ...
        <div className="glass p-4 sm:p-8 rounded-2xl sm:rounded-[2.5rem] border border-white/10 space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              ...
              <p className="text-[10px] text-slate-400 uppercase tracking-widest mt-1">
                Promote your service on social platforms
              </p>
            </div>
            <div className="w-10 h-10 bg-green-600 rounded-xl flex items-center justify-center text-white shadow-lg shrink-0">
          ...
          <div className="space-y-4">
            <div className="p-6 bg-white/5 rounded-xl border border-white/10">
              <h4 className="text-[9px] font-black text-green-400 uppercase tracking-widest mb-4">Share Message</h4>
              <textarea
                value={flyerBrief}
                onChange={(e) => setFlyerBrief(e.target.value)}
                placeholder="Create your advertisement message (e.g. Affordable campus rides available! Book now for quick and safe transportation...)"
                className="w-full min-h-[120px] bg-white/5 border border-white/10 rounded-xl p-4 text-white font-bold text-xs outline-none focus:border-green-500 transition-colors resize-y"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button
                onClick={() => {
                  const message = encodeURIComponent(flyerBrief);
                  window.open(`https://wa.me/?text=${message}`, '_blank');
                }}
                disabled={!flyerBrief.trim()}
                className="py-4 bg-green-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl disabled:opacity-50 hover:bg-green-500 transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                disabled={!flyerBrief.trim()}
                className="py-4 bg-blue-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl disabled:opacity-50 hover:bg-blue-500 transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                disabled={!flyerBrief.trim()}
                className="py-4 bg-indigo-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl disabled:opacity-50 hover:bg-indigo-500 transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                onClick={() => {
                  navigator.clipboard.writeText(flyerBrief);
                  alert('Advertisement message copied to clipboard!');
                }}
                disabled={!flyerBrief.trim()}
                className="py-4 bg-purple-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest shadow-xl disabled:opacity-50 hover:bg-purple-500 transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="p-4 bg-amber-500/10 rounded-xl border border-amber-500/20">
              ...
              <p className="text-xs text-slate-400">
                Share your advertisement during peak hours (morning 7-9am, evening 5-7pm) for maximum visibility. Include your contact information and service areas.
              </p>
            </div>
          </div>
        </div>
...
const App: React.FC = () => {
  ...
  const [liveMapRole, setLiveMapRole] = useState<'driver' | 'passenger'>('passenger');
        ...
        <>
            ...
            <div className="flex-1 space-y-1">
              ...
              <NavItem
                ...
                onClick={() => {
                  ...
                  setLiveMapRole(viewMode === "driver" ? "driver" : "passenger");
                }}
              />
          ...
          >
            <div className="max-w-6xl mx-auto space-y-6 lg:space-y-8">
              ...
              {showLiveMap && (
                <MapContainerWrapper
                  title={`${liveMapRole === 'passenger' ? 'Passenger' : 'Driver'} Live Tracking`}
                  isMaximized={false}
                  onMaximize={() => {}}
                  onMinimize={() => {}}
