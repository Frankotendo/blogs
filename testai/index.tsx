                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-black/50 rounded-lg p-4 border border-white/10">
                      <div className="text-center text-white">
                        <i className="fas fa-map-marked-alt text-4xl mb-3 text-indigo-400"></i>
                        <p className="text-sm font-medium mb-2">Route Preview</p>
                        <p className="text-xs text-slate-400 mb-3">
                          Click "Open in Google Maps" to see the complete route with turn-by-turn navigation
                        </p>
                        <div className="flex items-center justify-center gap-4 text-xs">
                          <div className="flex items-center gap-1">
                            <div className="w-3 h-3 bg-emerald-500 rounded-full"></div>
                            <span>Pickup: {node.origin}</span>
                          </div>
                          <div className="flex items-center gap-1">
