...
export const ForgotPasswordModal: React.FC<ForgotPasswordProps> = ({ 
  ...
  const [step, setStep] = useState(1); // 1: identify, 2: security questions, 3: new password, 4: success
  ...
  // Debug log
  console.log('ForgotPasswordModal rendered:', { userType, step, loading });
  ...
  const renderStep3 = () => (
    <div className="space-y-4">
      <h3 className="text-lg font-bold text-white mb-4">Step 3: Set New Password</h3>
      <div>
  ...
  const renderStep4 = () => (
    <div className="text-center space-y-4">
      ...
      <p className="text-gray-300">Your password has been successfully reset. You can now login with your new password.</p>
      <button
        onClick={onSuccess}
